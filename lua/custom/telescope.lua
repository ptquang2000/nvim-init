...
map("<leader>sG", function() builtin.git_files({ cwd = git_cwd() }) end, "Search Git Files")
map("<leader>gs", function() builtin.git_status({ cwd = git_cwd() }) end, "Git Status")
map("<leader>gS", function() builtin.git_stash({ cwd = git_cwd() }) end, "Git Stash")
map("<leader>gB", function() builtin.git_branches({ cwd = git_cwd(), show_remote_tracking_branches = false }) end, "Git Branches")
